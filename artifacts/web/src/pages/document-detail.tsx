      ...
      { id: docId },
      {
        onSuccess: async () => {
          ...
          toast({
            ...
            description: "O arquivo foi removido do sistema.",
          });
      ...
      <Layout>
        <div className="max-w-3xl mx-auto mt-20 text-center bg-card p-12 rounded-2xl border border-border shadow-sm">
          ...
          <p className="text-muted-foreground">
            O documento solicitado não existe ou você não tem acesso a ele.
          </p>
        </div>
      </Layout>
    );
              ...
              <div className="absolute inset-0 flex items-center justify-center p-8 text-center">
                <div className="max-w-md">
                  ...
                  <p className="text-muted-foreground mb-8">
                    Não é possível renderizar documentos DOCX diretamente no
                    navegador. O texto foi extraído e o assistente IA já tem
...
function ChatInterface({ documentId }: { documentId: number }) {
  const { messages, sendMessage, isTyping, isRevealing, error } =
    useChatStream(documentId);
        ...
        {messages.length === 0 ? (
          <div className="h-full flex flex-col items-center justify-center text-center opacity-70">
            ...
            <p className="text-sm text-muted-foreground max-w-[250px]">
              Faça perguntas específicas sobre cláusulas, prazos ou entidades
          ...
          messages.map((msg, i) => (
            ...
            >
              ...
              <div
                className={`p-3.5 rounded-xl max-w-[85%] leading-relaxed text-sm ${
                  msg.role === "user"
